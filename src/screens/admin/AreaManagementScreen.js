...
const AreaManagementScreen = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.card}>
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('AreaDetailAdmin', { areaId: item.id })}
      >
        ...
        <View style={styles.actionRow}>
          <TouchableOpacity
            ...
            onPress={(e) => {
              e.stopPropagation();
              navigation.navigate('EditArea', { area: item });
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={(e) => {
              e.stopPropagation();
              navigation.navigate('EmailRegister', { area: item });
            }}
          >
